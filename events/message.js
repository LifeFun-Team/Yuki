...
module.exports = async (bot, message) => {
  ...
  if(cmd.help.sponsor && !owners.includes(message.author.id) || !sponsors.includes(message.guild.id)) return message.say("Эта бонусная функция которая доступна только спонсорским серверам.");
